...
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports {bin_bcd_select[0]}] 
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports {bin_bcd_select[1]}] 
...
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {FSM_outputs[0]}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {FSM_outputs[1]}]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports DecimalBaseSelectButton]
...
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {compare_match_pwm}];#Sch name = JB1

#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {JB[1]}];#Sch name = JB2
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {compare_match_r2r}];#Sch name = JB2
